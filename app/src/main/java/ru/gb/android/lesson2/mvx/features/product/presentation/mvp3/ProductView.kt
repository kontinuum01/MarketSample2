...
class ProductViewImpl(
    ...
    private val progress: View by lazy { rootView.findViewById(R.id.progress) }
    private val image: ImageView by lazy { rootView.findViewById(R.id.image) }
    private val name: TextView by lazy { rootView.findViewById(R.id.name) }
    private val price: TextView by lazy { rootView.findViewById(R.id.price) }
    private val promo: TextView by lazy { rootView.findViewById(R.id.promo) }
    private val addToCart: View by lazy { rootView.findViewById(R.id.addToCart) }
